...
Page({
    ...
    onShareAppMessage: function () {
        return {
          ...
          path: `/pages/district/share_detail/share_detail?goodsId=${_this.data.goodsId}&grouponsId=${_this.data.grouponsId}&shopId=${_this.data.shopId}&price=${_this.data.grouponPrice}&orderId=${_this.data.orderId}&agencyId=${app.globalData.agencyId}`,
